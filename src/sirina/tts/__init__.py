    ...
    **kwargs: Any,
    ...
    Parameters:
        voice (str): The type of TTS engine to use:
            - "sirina": Sirina voice synthesizer
    ...
    """
    if voice.lower() == "sirina":
        from . import tts_sirina

        return tts_sirina.SpeechSynthesizer(**kwargs)
    ...
    return tts_kokoro.SpeechSynthesizer(voice=voice, **kwargs)
