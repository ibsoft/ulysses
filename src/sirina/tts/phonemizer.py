...
from ..config import (
    TTS_PHONEMIZER_DICT_PATH,
    TTS_PHONEMIZER_IDX_TO_TOKEN_PATH,
    TTS_PHONEMIZER_MODEL_PATH,
    TTS_PHONEMIZER_TOKEN_TO_IDX_PATH,
...
class ModelConfig:
    ...
    def __init__(
        ...
        self.MODEL_PATH = model_path if model_path is not None else TTS_PHONEMIZER_MODEL_PATH
        self.PHONEME_DICT_PATH = phoneme_dict_path if phoneme_dict_path is not None else TTS_PHONEMIZER_DICT_PATH
        self.TOKEN_TO_IDX_PATH = (
            token_to_idx_path if token_to_idx_path is not None else TTS_PHONEMIZER_TOKEN_TO_IDX_PATH
        )
        self.IDX_TO_TOKEN_PATH = (
            idx_to_token_path if idx_to_token_path is not None else TTS_PHONEMIZER_IDX_TO_TOKEN_PATH
        )
...
class Phonemizer:
    ...
    def __init__(self, config: ModelConfig | None = None) -> None:
        ...
        Notes:
            - Adds a special phoneme entry for "sirina"
        ...
        self.phoneme_dict["sirina"] = "sɪɹˈiːnə"
