...
from ..config import ASR_CTC_CONFIG_PATH, ASR_CTC_MODEL_PATH, configure_onnxruntime_logging, get_onnx_providers
...
class AudioTranscriber:
    DEFAULT_MODEL_PATH = ASR_CTC_MODEL_PATH
    DEFAULT_CONFIG_PATH = ASR_CTC_CONFIG_PATH
